...
public class PressurePlate : MonoBehaviour
{
    ...
    {
        if (isReversed && (collision.gameObject.tag == "Player" || collision.gameObject.tag == "Peckable")) 
        {
            toggleReverseEnable(); 
        }
        else if ((collision.gameObject.tag == "Player" || collision.gameObject.tag == "Peckable"))
        {
            toggleEnable();        
        }
    }
